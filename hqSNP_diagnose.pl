...
# Run this script in the folder where your bam files are present
...
sub gsize()  #Subroutine to calculate size of Genome
{
               ...
               print "Genome Size: $total_ref_bases\n";
